...
enum tp_tuner_stat_id {
    ...
    TP_TUNER_STAT_RDY_MISS,
    TP_TUNER_STAT_ISR_N,
    TP_TUNER_STAT_ISR_RDY_LOW,
    TP_TUNER_STAT_ISR_TO_READ_MAX_US,
    TP_TUNER_STAT_I2C_AVG_US,
    TP_TUNER_STAT_I2C_ALL_MAX_US,
    TP_TUNER_STAT_END_ERR,
...
static inline const char *tp_tuner_stat_name(uint16_t id) {
    static const char *const names[TP_TUNER_STAT_COUNT] = {
        ...
        [TP_TUNER_STAT_RDY_MISS] = "rdy_miss",
        [TP_TUNER_STAT_ISR_N] = "isr_n",
        [TP_TUNER_STAT_ISR_RDY_LOW] = "isr_rdy_low",
        [TP_TUNER_STAT_ISR_TO_READ_MAX_US] = "isr_to_read_max_us",
        [TP_TUNER_STAT_I2C_AVG_US] = "i2c_avg_us",
        [TP_TUNER_STAT_I2C_ALL_MAX_US] = "i2c_all_max_us",
        [TP_TUNER_STAT_END_ERR] = "end_err",
